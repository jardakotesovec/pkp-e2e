 ...
 *
 * OPS-local Page Object and flow helpers for the Highlights feature
 * (spec: docs/specs/U11-highlights.md): the OJS sibling
 * (apps/ojs/playwright/pages/HighlightsPages.js) in a preprint server's
 * vocabulary. The shared HighlightsListPanel and highlights.tpl are the same
 * on all three apps; only the home page's block class differs
 * (`div.page_index_server`). Duplication between app suites is deliberate
 * (PRINCIPLES M1).
 *
 * Surfaces:
 ...
 * highlights.tpl, confirmed against the running OPS app while this suite was
...
exports.carousel = function carousel(page) {
    ...
    return {
        ...
        /**
         * The home page's blocks (`div.page_index_server`'s children): the
         * carousel first, then the archive header and "Latest preprints".
         */
        pageBlocks: page.locator('.pkp_structure_main > div.page_index_server > div'),
    };
};
