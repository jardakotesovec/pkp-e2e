...
### U01 — Login & sessions {OJS OMP OPS}
...
### U02 — Registration & account validation {OJS OMP OPS}
...
### U04 — ORCID integration {OJS OMP OPS}
...
### U05 — Notifications center & email preferences {OJS OMP OPS}
...
### U06 — User invitations {OJS OMP OPS}
...
### U07 — Journal identity & about pages {OJS OMP OPS}
...
### U08 — Navigation menus & site chrome {OJS OMP OPS}
...
### U09 — Custom pages & blocks {OJS OMP OPS}
...
### U10 — Appearance & theming {OJS OMP OPS}
...
### U20 — Search-engine metadata & analytics {OJS OMP OPS}
...
### U21 — Submission wizard {OJS OMP OPS}
...
### U22 — My Submissions (author dashboard) {OJS OMP OPS}
...
### U23 — Submissions dashboard (editorial) {OJS OMP OPS}
...
### U27 — Reviewer assignment & management {OJS OMP}
...
### U29 — Review setup & review forms {OJS OMP}
...
### U30 — Author response to reviews {OJS}
...
### U31 — Reviewer suggestions {OJS OMP}
...
### U33 — Production stage {OJS OMP OPS}
...
### U34 — Editorial decision recording {OJS OMP OPS}
...
### U35 — Stage participants {OJS OMP OPS}
...
### U36 — Submission files {OJS OMP OPS}
...
### U37 — Tasks & discussions {OJS OMP OPS}
...
### U38 — Submission activity log & notes {OJS OMP OPS}
...
### U39 — Submission & Publisher Libraries {OJS OMP OPS}
...
### U40 — Publication metadata {OJS OMP OPS}
...
### U41 — Contributors & affiliations {OJS OMP OPS}
...
### U42 — Citations & references {OJS OMP OPS}
...
### U44 — Identifiers (publisher IDs & URN) {OJS OMP OPS}
...
### U51 — Subscriptions & open access control {OJS}
...
### U54 — Roles configuration {OJS OMP OPS}
...
### U55 — Notify users (bulk email) {OJS OMP OPS}
...
### U56 — Emails management {OJS OMP OPS}
...
### U57 — Languages & locales {OJS OMP OPS}
...
### U58 — Submission intake configuration {OJS OMP OPS}
...
### U59 — Hosted journals (site admin) {OJS OMP OPS}
...
### U61 — System administration & jobs {OJS OMP OPS}
...
### U62 — Plugins management {OJS OMP OPS}
...
### U67 — Archiving & preservation {OJS}
