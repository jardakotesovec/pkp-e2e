...
| U03 | User profile | OJS OMP OPS | M | in_progress | Draft spec written 2026-09-03 (14 rules, 10 scenarios per app, register 5🐞+4❓+2✅ all unprobed; headliner A8: the email-change confirmation goes to the old address). 35-item probe list in `.reports/u03-user-profile/`; lint clean; probes running (RUNBOOK step 3). |
