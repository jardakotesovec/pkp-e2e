...
|----|---------------------------|------|-----------------|--------|-----------------------------|
| U21-A11 🐞 | About 100 of 129 OJS tests red at once: every test that seeds a submission fails with `POST …/_test/scenarios/submission failed: 500` (`Author::getAffiliations()` TypeError); the real wizard start 500s the same way | ojs (omp, ops inherit at their next pkp-lib bump) | U21 register A11 (regression, pkp-lib `9e2fbac214`) | open. 2026-09-01: fix PR pkp/pkp-lib#13265 verified at the PR ref, full OJS suite 129/129 green; awaiting merge and the ojs pointer bump | 2026-09-01 / 2026-09-01 |
