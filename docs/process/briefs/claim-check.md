...
Budget: about 40 browser calls (step 3's ceiling). When you reach it, write the report on what you have, list the remaining checklist lines by number, and exit.
