...
Any throwaway check you drive by hand uses the probe kit with `PROBE_FEATURE={{feature}} PROBE_AGENT={{agent}}`, sized for about 40 browser calls (RUNBOOK step 3); tests never import the kit.
