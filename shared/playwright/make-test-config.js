...
const PATCHES = {
    ...
    database: {
        ...
        name: dbName,
        // Honoured once pkp-lib carries the persistent-connection setting
        // (docs/reports/2026-09-14-suite-performance-round2.md); an app
        // without it ignores the key.
        persistent: 'On',
    },
    i18n: {
...
const out = patchIni(template, PATCHES);
